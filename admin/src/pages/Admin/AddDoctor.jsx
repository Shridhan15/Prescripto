      ...
      <div className="bg-white px-8 py-9 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          <label htmlFor="doc-img">
            <img className="w-16 cursor-pointer bg-gray-100 rounded-full" src={assets.upload_area} alt="" />
          </label>
        ...
        <div>
          ...
          <textarea className="w-full px-4 pt-2 border rounded" placeholder="write about doctor" rows={5}></textarea>
        </div>

        <button className="cursor-pointer bg-primary px-10 py-3 mt-4 text-white rounded-full">Add Doctor</button>
      </div>
    </form>
  );
};
